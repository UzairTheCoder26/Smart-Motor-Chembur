        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="relative animate-fade-up">
            <div className="relative rounded-2xl overflow-hidden gold-border-glow">
              <img src={aboutImg} alt="Smart Motor instructor" className="w-full h-[500px] object-cover" loading="lazy" />
            ...
            <div className="absolute -bottom-6 -right-4 md:right-8 px-6 py-4 rounded-2xl bg-gradient-gold text-primary-foreground shadow-gold animate-float">
              ...
              <div className="font-display text-3xl">2015</div>
            </div>
          </div>

          <div className="animate-fade-up delay-200">
            <div className="inline-block px-3 py-1 rounded-full glass mb-4">
              <span className="text-xs font-orbitron tracking-[0.2em] text-primary">ABOUT US</span>
            </div>
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight">
              Your Journey to <span className="text-gold-gradient">Confident Driving</span> Starts Here
            </h2>
            <p className="text-foreground/70 text-lg leading-relaxed mb-8">
              At Smart Motor Driving School, we don't just teach driving — we build confidence. With over a decade of experience training drivers across Chembur, Tilak Nagar and the eastern suburbs of Mumbai, our certified instructors specialise in patient, real-traffic instruction tailored to every learner.
            </p>
            ...
            <a
              href="#courses"
              className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full border border-primary/40 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 font-medium"
            >
